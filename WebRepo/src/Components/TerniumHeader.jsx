...
export default function TerniumHeader()  {
    ...
    const handleLogout = async () => {
        ...
        navigateTo('/login'); // Navigate to the login page after logout
      };
    return (
        <div className="TerniumHeader">
            <nav id="bar">
                ...
                <div>
                <Link className='btn me-1 text-white' to="/registro" style={{ backgroundColor: "rgb(237, 139, 68)" }}>Registrarse</Link>
                <Link className='btn me-1 text-white' to="/login" style={{ backgroundColor: "rgb(237, 139, 68)" }}>Log in</Link>
                <button className='btn me-1 text-white' style={{ backgroundColor: "rgb(237, 139, 68)" }} onClick={handleLogout}>Log out</button>
